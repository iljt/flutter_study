...
void main(){
  new File("r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\ttt.txt"").readAsString().then((content){
      print(content);
  });
  while(true){}
}
...
```dart
 Future readDone = new File("r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\ttt.txt"").readAsString();
  //延迟3s
...
```dart
 new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\UCore_1.0_2021-08-25.apk).openRead().listen((List<int> bytes) {
    print("stream执行"); //执行多次
  });

  new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\UCore_1.0_2021-08-25.apk).readAsBytes().then((_){
    print("future执行"); //执行1次
  });
```
...
```dart
  StreamSubscription<List<int>> listen = new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\UCore_1.0_2021-08-25.apk).openRead().listen((List<int> bytes) {
    print("stream执行");
  });
  listen.onData((_){
    print("替代listene");
...
```dart
var stream = new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\UCore_1.0_2021-08-25.apk).openRead();
...
//  });
  ...
  var broadcastStream = new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\UCore_1.0_2021-08-25.apk).openRead().asBroadcastStream();
...
Future<String> readFile() async {
  ...
  String content = await new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\ttt.txt").readAsString();
  String content2 = await new File(r"C:\Users\W10\AndroidStudioProjects\flutter_app\lib\3、异步编程\ttt.txt").readAsString();
  //自动转换为 future
  return content;
}
```
